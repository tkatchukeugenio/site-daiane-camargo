  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-6">
        <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#C8B4E4] rounded-full mix-blend-multiply filter blur-3xl opacity-40 z-0 animate-pulse" />
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="flex flex-col space-y-8 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a href="#" className="px-8 py-4 bg-[#C8B4E4] hover:bg-[#A890C8] text-[#2D2D2D] font-semibold rounded-full transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Quero iniciar minha jornada
              </a>
            </div>
          </div>
          <div className="relative flex justify-center">
            <div className="relative z-10 w-full max-w-[400px] rounded-[60px] overflow-hidden shadow-2xl border-8 border-white">
              <img src="/daiane.jpg" alt="Daiane Camargo" className="w-full h-full object-cover scale-105" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="especialidades" className="py-24 bg-white relative z-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-semibold text-[#2D2D2D] mb-4 text-balance">
              Como posso te ajudar em sua jornada?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-balance">
            {[
              ...
              <div key={i} className="p-8 rounded-[40px] bg-[#FAFAFA] border border-[#C8B4E4]/10 hover:border-[#C8B4E4]/40 transition-all duration-500 hover:shadow-2xl group">
                ...
                <button className="text-[#A890C8] font-semibold hover:underline inline-flex items-center gap-2">Saiba mais <span>→</span></button>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-[#5C5C5C] leading-relaxed font-light italic border-l-4 border-[#C8B4E4] pl-6 text-balance">
            ...
            <div className="w-full md:w-1/2 relative">
               <div className="bg-white p-8 rounded-[50px] shadow-xl border border-[#C8B4E4]/10">
                  <span className="text-5xl block mb-4">🤝</span>
                  <h4 className="text-[#2D2D2D] font-bold text-xl mb-2">Compromisso Ético</h4>
                  <p className="text-[#5C5C5C] text-sm">Espaço seguro e sigiloso, respeitando todas as vivências e identidades.</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5C5C5C] font-light italic text-balance">Esclarecendo as dúvidas mais comuns sobre o processo terapêutico.</p>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-[#C8B4E4]/20 rounded-[24px] overflow-hidden transition-all duration-300">
                <button 
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-semibold text-[#2D2D2D] md:text-lg">{faq.question}</span>
                  </div>
                  <span className={`text-[#A890C8] transform transition-transform duration-300 ${activeFaq === index ? 'rotate-180' : ''}`}>
                    ▼
                  </span>
                </button>
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${activeFaq === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <div className="p-6 pt-0 text-[#5C5C5C] leading-relaxed bg-white text-sm md:text-base border-t border-[#C8B4E4]/10">
                    {faq.answer}
                  </div>
                </div>
              </div>
