  ...
  return (
    <div className="flex flex-col w-full text-left">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10 text-left">
          <div className="flex flex-col space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium leading-[1.1] text-[#2D2D2D] text-left">
              Ressignifique a sua história num espaço seguro, com <span className="text-[#A890C8] font-bold">empatia e acolhimento.</span>
            </h1>
            <p className="text-lg md:text-xl text-[#5C5C5C] leading-relaxed max-w-lg font-light text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a href="https://wa.me/5542991451871" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-[#C8B4E4] hover:bg-[#A890C8] text-[#2D2D2D] font-semibold rounded-full transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
      ...
      <section id="especialidades" className="py-24 bg-white relative z-20 text-left">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-[40px] bg-[#FAFAFA] border border-[#C8B4E4]/10 hover:border-[#C8B4E4]/40 transition-all duration-500 hover:shadow-2xl group text-left">
      ...
      {/* --- SEÇÃO SOBRE MIM --- */}
      <section id="sobre" className="py-24 bg-[#FAFAFA] text-left">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 space-y-6 text-left">
              <h2 className="text-3xl md:text-4xl font-semibold text-[#2D2D2D] text-left">Sobre a Daiane Camargo</h2>
              <p className="text-lg text-[#5C5C5C] leading-relaxed font-light italic border-l-4 border-[#C8B4E4] pl-6 text-left">
                "Acredito que a terapia não é sobre cura, mas sobre encontrar o seu caminho, ainda que dentro de uma jornada difícil."
              </p>
              <p className="text-[#5C5C5C] leading-relaxed text-left">
      ...
      <section className="py-24 bg-white text-left">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-4 text-left">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-[#C8B4E4]/20 rounded-[24px] overflow-hidden text-left">
                <button 
                ...
                >
                  <div className="flex items-center gap-4 text-left">
                    ...
                    <span className="font-semibold text-[#2D2D2D] text-left">{faq.question}</span>
                  </div>
                ...
                <div className={`overflow-hidden transition-all duration-500 ${activeFaq === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <div className="p-6 pt-0 text-[#5C5C5C] leading-relaxed border-t border-[#C8B4E4]/10 text-left">
                    {faq.answer}
                  </div>
                </div>
              </div>
